...
const I18N = {
  ar: {
    ...
    subtitle: "اكتشاف الاقتباسات مع مراجع الآيات",
    h1: "اكتشاف الاقتباسات القرآنية",
    hint: "الصق النص هنا، ثم اضغط «اكتشاف».",
    inputLabel: "النص",
  ...
  en: {
    ...
    subtitle: "Detect citations with verse references",
    h1: "Detect Quranic Citations",
    hint: "Paste your text, then press “Detect”.",
